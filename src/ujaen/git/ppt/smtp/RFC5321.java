...
public class RFC5321 {
	...
	public static final String[] SMPT_REPLY_MESSAGES ={ "Servicio OK","El servicio está cerrando el canal de transmisión",
			"Ok","Inicie el envío del correo; termine con <CRLF>.<CRLF>"};
